...
Each dataset is analyzed to explore relationships between music characteristics, popularity, and artist statistics.
...
To improve interpretability of restults, a seperate file artist_data_visualization.py was created. This file contains functions used to generate visual representations of the dataset, making trends and relationships easier to interpret.
### Findings
